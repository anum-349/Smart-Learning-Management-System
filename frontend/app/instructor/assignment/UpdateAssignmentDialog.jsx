...
const DUMMY_ASSIGNMENT = {
  ...
  title: "Initial Web Dev Assignment - Topic 1",
  description: "Please review HTML fundamentals before starting.",
  totalMarks: 50,
  deadline: "2025-12-01",
  fileName: "Assignment_instructions_v1.pdf",
};
...
export default function UpdateAssignmentModal({
  ...
  const handleSubmit = async (e) => {
    ...
    /* 🔹 Replace with real API */
    // await fetch(`/api/instructor/assignments/${assignmentId}`, {
    //   method: "PUT",
    //   body: formData,
    // });
  ...
  return (
    <Modal isOpen={isOpen} onClose={onClose} title="Update Assignment">
      {loading ? (
        <p className="text-center text-gray-900">Loading assignment...</p>
      ) : (
